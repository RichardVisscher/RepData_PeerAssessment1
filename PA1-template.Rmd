...
```
####  On average, across all the days in the dataset, the 5 minute interval `r maxtime` contains the maximum number of steps.
...
```
#### The total number of missing values is `r numbermissing`
